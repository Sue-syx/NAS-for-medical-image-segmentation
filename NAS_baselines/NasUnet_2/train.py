...
class Network(object):
    ...
    def _init_dataset(self):
        ...
        trainset = CHAOS_CT(root='./dataset/CHAOS/Train_Sets/CT/', image_size = 512, mode='train')
        valset = CHAOS_CT(root='./dataset/CHAOS/Train_Sets/CT/', image_size = 512, mode='valid')
    ...
    def _init_model(self):
        ...
        print("self.cfg['training']['multi_gpus']:",self.cfg['training']['multi_gpus'])
