...
if __name__ == '__main__':
	...
	dataset = ImageFolder(root = train_root, image_size = 224, mode='train',augmentation_prob=0.4)
	...
	for batch_index,(images,target) in enumerate(train_queue):
		if batch_index == 0: 
			print(target[:,:,50:100,50:100])
			break